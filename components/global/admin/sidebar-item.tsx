  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && "flex items-center text-slate-700 focus:text-green-600 active:text-green-600 px-2 pl-6   dark:text-white hover:bg-slate-300/20 hover:text-green-700"
      )}
    >
